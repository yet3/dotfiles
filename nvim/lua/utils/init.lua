function _G.safe_plug_load(plug_name, plug_config)
  ...
  if (not status) then
    ...
    local msg = "Error while loading plugin: " .. plug_name

    msg = msg .. "\n\nPlugin info:\n"
    msg = msg .. " url: " .. plug_config[1]
    if plug_config.name then msg = msg .. "\n name: " .. plug_config['name'] end
    if plug_config.branch then msg = msg .. "\n branch: " .. plug_config['branch'] end
    if plug_config.tag then msg = msg .. "\n tag: " .. plug_config['tag'] end
    if plug_config.priority then msg = msg .. "\n priority: " .. plug_config['priority'] end
